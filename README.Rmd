...
There are `r total.preprints` preprints in the arXiv dataset, with a total of `r format(total.authors, scientific=FALSE)` non-unique authors. I inferred the gender of `r total.authors.with.gender` authors, or `r per.gender`%, with the rest omitted from subsequent analyses. 
