...
To put some numbers on this, arXiv preprints with female corresponding authors have increased `r a.fem.per.increase`% between Jan/Feb 2020 and Mar/Apr 2020, while bioRxiv preprints with male corresponding authors have increased `r a.m.per.increase`% over the same period. 
