...
There are `r total.b.preprints` preprints in the bioRxiv dataset for 2019-2020. Because the bioRxiv analysis focuses on corresponding authors only, and each preprint has a single corresponding author, there are also `r total.b.authors` non-unique corresponding authors. I inferred the gender of `r total.b.authors.with.gender` corresponding authors, or `r per.b.gender`%, with the rest omitted from subsequent analyses. 
