...
```{r, Combine visualizations, message=FALSE, warning=FALSE, fig.width=8, fig.height=8, dpi=300}
...
Throughout this analysis, effects are conservative because many preprints describe research completed months ago.
