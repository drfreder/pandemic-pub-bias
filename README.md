...
I also made an additional, simpler figure to accompany a story I wrote
for *The Conversation.*

``` r
#arXiv, simplified
all.t$per.dif.1819 <- ((all.t$`2019`-all.t$`2018`)/(all.t$`2018`))*100 #Calculate percent change, 2019 over 2018
all.t.t <- as.data.frame(t(all.t))
all.t.t$dif <- as.numeric(all.t.t$Female) - as.numeric(all.t.t$Male)
all.t.t <- all.t.t[4:5, ]
all.t.t$Year <- c("2019 to 2020","2018 to 2019")
...
bio.t$dif <- as.numeric(bio.t$Female) - as.numeric(bio.t$Male)
bio.t <- bio.t[4:5,]
bio.t$Year <- c("2019 to 2020","2018 to 2019")
