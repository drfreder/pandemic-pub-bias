...
same date range in 2019. I scraped the data in batches, as recommended
in the aRxiv package tutorial.
...
I calculated how many male and female authors there were on arXiv
preprints in 2020 versus 2019.
...
```
    ...
    ##   date = col_double(),
    ##   year = col_double(),
    ##   first.author.prop.male = col_double(),
    ##   last.author.prop.male = col_double(),
    ##   male.n = col_double(),
    ##   female.n = col_double(),
    ##   prop.female.authors = col_double(),
    ##   prop.female.authors.ex.single = col_double()
    ## )
...
```
    ...
    ##   author_corresponding = col_character(),
    ##   author_corresponding_institution = col_character(),
...
Finally, I plot the numbers of male and female corresponding authors on
bioRxiv preprints between Mar/Apr 2019 and Mar/Apr
2020.
